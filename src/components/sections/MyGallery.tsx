...
const MyGallery: React.FC = () => {
  ...
  const galleryItems = [
    { image: '/assets/view 1.webp', text: 'Me' },
    { image: '/assets/view 8.webp', text: 'Monas' },
    { image: '/assets/view 14.webp', text: 'Prambanan Temple' },
    { image: '/assets/view 16.webp', text: 'First Year College' },
    { image: '/assets/view 24.webp', text: 'Me & Friends' },
    { image: '/assets/view 18.webp', text: 'My Graduation' },
    { image: '/assets/view 20.webp', text: 'Javan Moment' },
    { image: '/assets/view 22.webp', text: 'FIFGroup Moment' },
    { image: '/assets/brin-momen.webp', text: 'BRIN Moment' },
    { image: '/assets/phr-momen.webp', text: 'PHR Moment' }
  ];
